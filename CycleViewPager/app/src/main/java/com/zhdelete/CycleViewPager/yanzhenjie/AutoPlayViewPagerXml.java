 ...
 */
public class AutoPlayViewPagerXml extends ViewPager {

    private static final String TAG = "AutoPlayViewPagerXml";

    public AutoPlayViewPagerXml(Context context) {
        super(context);
    }

    public AutoPlayViewPagerXml(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
